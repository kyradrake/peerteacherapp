...
RSpec.describe AdministratorsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested administrator as @administrator" do
      administrator = Administrator.create! valid_attributes
      get :show, params: {id: administrator.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested administrator as @administrator" do
      administrator = Administrator.create! valid_attributes
      get :edit, params: {id: administrator.to_param}, session: valid_session
      expect(assigns(:administrator)).to eq(administrator)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Administrator" do
        expect {
          post :create, params: {administrator: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved administrator as @administrator" do
        post :create, params: {administrator: invalid_attributes}, session: valid_session
        expect(assigns(:administrator)).to be_a_new(Administrator)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested administrator" do
        administrator = Administrator.create! valid_attributes
        put :update, params: {id: administrator.to_param, administrator: new_attributes}, session: valid_session
      ...
      it "assigns the requested administrator as @administrator" do
        administrator = Administrator.create! valid_attributes
        put :update, params: {id: administrator.to_param, administrator: valid_attributes}, session: valid_session
        expect(assigns(:administrator)).to eq(administrator)
      end
    ...
    context "with invalid params" do
      it "assigns the administrator as @administrator" do
        administrator = Administrator.create! valid_attributes
        put :update, params: {id: administrator.to_param, administrator: invalid_attributes}, session: valid_session
        expect(assigns(:administrator)).to eq(administrator)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested administrator" do
      administrator = Administrator.create! valid_attributes
      expect {
        delete :destroy, params: {id: administrator.to_param}, session: valid_session
      }.to change(Administrator, :count).by(-1)
    end
